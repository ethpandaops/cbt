  ...
  return (
    <div className="space-y-2">
      {[1, 2, 3, 4, 5, 6, 7, 8].map(rowIndex => (
        <div
          key={rowIndex}
          className="rounded-xl border border-scheduled/35 bg-linear-to-br from-surface/95 via-surface/86 to-secondary/30 shadow-sm ring-1 ring-border/45 backdrop-blur-sm"
        >
