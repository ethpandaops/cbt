      ...
      {tooltipsData.map(tooltip => {
        ...
        return (
          <div
            ...
            className={`fixed rounded px-1.5 py-0.5 text-[10px] whitespace-nowrap text-white opacity-100 shadow-lg ring-1 ${
              tooltip.isMissing ? 'bg-danger/90 ring-danger/30' : 'bg-background ring-border/30'
            }`}
            style={{
